<div class="container-fluid hero pb-5">
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light bg-transparent">
            <a class="navbar-brand" href="#">AppsDirect</a>
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                ...
                <div class="form-inline my-2 my-lg-0">
                    ...
                    <a class="btn  my-2 my-sm-0 bt-nav" href="#">Order Now</a>
                </div>
            </div>
        </nav>
        <div class="row mt-5">
            <div class="col-md-6">
                ...
                <a class="btn my-2 my-sm-0  text-dark" href="#">Google Sing Up</a>
            </div>
